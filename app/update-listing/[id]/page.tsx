...
import { FaCloudUploadAlt, FaTrash, FaHome, FaMapMarkerAlt, FaBed, FaBath, FaParking, FaChair, FaTag, FaSync } from "react-icons/fa";
    ...
    return (
        <main className="min-h-screen bg-background pb-20">
            <div className="max-w-6xl mx-auto px-6">
                <div className="pt-16 pb-12 text-center lg:text-left flex flex-col lg:flex-row lg:items-end justify-between gap-6">
                    <div>
                        <h1 className="text-4xl font-outfit font-extrabold text-primary mb-2">Refine Listing</h1>
                        <p className="text-text-muted">Update your property details to keep them accurate and appealing.</p>
                    </div>
                    <div className="flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-sm border border-slate-100 text-xs font-bold text-slate-400 uppercase tracking-widest">
                        <FaSync size={10} /> Syncing with Cloud
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                    ...
                    <div className="space-y-8 flex flex-col">
                            ...
                            <div className="flex gap-4">
                                <div className="flex-1">
                                    ...
                                    >
                                        ...
                                        <span className="font-bold text-slate-500 text-sm">{files && files.length > 0 ? `${files.length} selected` : 'Select more images'}</span>
                                    </label>
                                </div>
                                <button
                                    type="button"
                            ...
                            <div className="grid grid-cols-2 gap-4 mt-6">
                                {formData.imageURL.length === 0 && (
                                    <div className="col-span-full py-20 bg-slate-50/50 rounded-3xl border-2 border-dashed border-slate-100 flex items-center justify-center">
                                        <p className="text-slate-300 text-sm font-bold uppercase tracking-widest">Property preview</p>
                                    </div>
                                )}
                        ...
                        <div className="mt-8">
                            ...
                            >
                                {loading ? "Saving Changes..." : "Secure Update"}
                            </button>
